 ...
 *
 * @param filePath   The the file to open.
 * @param bFailQuietly If FALSE an Error is issued for non-8211 files,
...
int DDFModule::Open( const char * filePath, int bFailQuietly )
