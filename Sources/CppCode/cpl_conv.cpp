...
FILE *CPLOpenShared( const char *filePath, const char *pszAccess,
                     int bLarge )
...
/* -------------------------------------------------------------------- */
    ...
    {
        if( strcmp(pasSharedFileList[i].pszFilename,filePath) == 0 
...
/* -------------------------------------------------------------------- */
    ...
    if( bLarge )
        fp = VSIFOpenL( filePath, pszAccess );
    else
        fp = VSIFOpen( filePath, pszAccess );
...
/* -------------------------------------------------------------------- */
    ...
    pasSharedFileList[nSharedFileCount-1].pszFilename =CPLStrdup(filePath);
